...
DATABASES = {
    'default': {
        ...
        'NAME': 'torneo',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'wl2mmn+!f0zq=^rtw#tn5a5jk7ry9_usp)g78t8+o2aa0&a-p%'
...
#EMAIL_HOST = '10.20.2.16'
EMAIL_HOST_USER = 'fhersa@gmail.com'
EMAIL_HOST_PASSWORD = 'diego2106'
EMAIL_PORT = 587
#EMAIL_PORT = 25
